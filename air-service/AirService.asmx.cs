...
namespace air_service
{
    ...
    public class AirService : System.Web.Services.WebService
    {
        ...
        [WebMethod]
        public DataSet GetAirCarriers(int dCity, string dState, int aCity, string aState)
        {
        ...
        [WebMethod]
        public DataSet GetFlights() //(carrier As Object, Departure City, Departure State, Arrival City, Arrival State
        {
        ...
        [WebMethod]
        public DataSet FindFlights()//(requirements As Object, Departure City, Departure State, Arrival City, Arrival State) 
        {
